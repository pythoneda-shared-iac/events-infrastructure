...
"""
pythoneda/shared/iac/events/infrastructure/dbus/docker_resources_update_failed.py
...
from pythoneda.shared.iac.events import DockerResourcesUpdateFailed
from pythoneda.shared.iac.events.infrastructure.dbus import DBUS_PATH
from typing import List


class DbusDockerResourcesUpdateFailed(BaseObject, ServiceInterface):
    """
    Represents the moment Docker resources have not been updated.

    Class name: DbusDockerResourcesUpdateFailed
    ...
    def __init__(self):
        ...
        """
        super().__init__("Pythoneda_Iac_DockerResourcesUpdateFailed")
    ...
    def DockerResourcesUpdateFailed(
        ...
        """
        Defines the DockerResourcesUpdateFailed d-bus signal.
    ...
    @classmethod
    def transform(cls, event: DockerResourcesUpdateFailed) -> List[str]:
        """
        Transforms given event to signal parameters.
        :param event: The event to transform.
        :type event: pythoneda.shared.iac.events.DockerResourcesUpdateFailed
    ...
    @classmethod
    def sign(cls, event: DockerResourcesUpdateFailed) -> str:
        """
    ...
    @classmethod
    def parse(cls, message: Message) -> DockerResourcesUpdateFailed:
        """
        Parses given d-bus message containing a DockerResourcesUpdateFailed event.
        :param message: The message.
        :type message: dbus_next.Message
        :return: The DockerResourcesUpdateFailed event.
